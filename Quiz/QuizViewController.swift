...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //------------------------ここから下にクイズを書く------------------------//
        tmpArray.append(["アントニーの嫌いな食べ物は？", "らっきょ", "梅干し", "パクチー", 3])
        tmpArray.append(["アントニーが好きなNFLのチームは？", "NYGiants", "GPackers", "CBears", 1])
        tmpArray.append(["アントニーが好きなNFLの選手は？", "Sweezy",  "OBJ", "Bredy", 2])
        tmpArray.append(["アントニーのアメフトのポジションは？", "LB", "QB", "WR", 1])
        //------------------------ここから上にクイズを書く------------------------//
